...
for patient = patients 
    ...
    [bar_travelling_waves] = plot_bar_travel_waves(patient, patientStructFull, ...
                                                   bad_channels); 
                                               
    bar_traveling_fname = [flag_results '_bar_travelling_waves_all_int_patient_' num2str(patient)]; 
    if flag_use_every_second_channel
    ...
    [rates_plot] = plot_bar_rates(patient, patientStructFull, ...
    ...
    saveas(brain, fullfile(paths.prop_plots_path, ...
                           ['propagation_layout_pat_' num2str(patient) ...
                           '_position_' position ...
